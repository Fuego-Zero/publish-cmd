...
const projectPath = "E:/work/BJ-dining_publish";
...
module.exports = {
    ...
    publish  : {
        destPath     : 'E:/work/BJ-dining_dist',
        name         : 'canteenxcx',//服务器发布名称
        index        : 'E:/work/BJ-dining_dist/index.html',
        copy         : [
    ...
    packages : {
        wxConcatJson: 'http://package.jjiehao.com/BJ-dining.json'
    }
};