...
const project = ['百捷食堂PC后台', '百捷食堂小程序', '商城小程序第20迭代', '商城小程序PC后台', '极捷号2.0 PC后台', '外送版小程序', '门店版小程序'];
...
inquirer.prompt([{
    ...
    switch (answers.name) {
        ...
        case '极捷号2.0 PC后台':
            ...
            break;
        case '外送版小程序':
            wechatApplet.publish(config.ShopStore_takeout);
            break;
        case '门店版小程序':
            wechatApplet.publish(config.ShopStore);
            break;
    }
